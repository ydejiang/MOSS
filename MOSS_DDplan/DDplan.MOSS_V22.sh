...
output_Dir=/home/data/data/ydj/NGC6517/DDplan-MOSS
...
# DDplan.py files
mv ${Source_name}_de-DM_MOSS.comd ${output_Dir}/ss_commands
mv dedisp_${Source_name}.py ${output_Dir}/ss_commands
mv ${Source_name}.eps ${output_Dir}/ss_commands
