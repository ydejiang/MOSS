...
# dedisperse_all_fil="dedisperse_all_fil -v -t 4 --td --ddplan ${output_Dir}/ddplan_PulsarX.txt -z kadaneF 8 4 zdot --format presto --cont --psrfits"
dedisperse_all_fil="dedisperse_all_fil -v -t 4 --td ${td} --fd ${fd} --dms ${dms} --ddm ${ddm} --ndm ${ndm} -z kadaneF 8 4 zdot --format presto --cont --psrfits"
realfft="realfft -fwd "
rednoise="rednoise "
